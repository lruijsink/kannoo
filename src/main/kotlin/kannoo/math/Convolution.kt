...
fun convOutputDims(input: Dimensions, kernel: Dimensions, padding: Padding?, stride: Dimensions?): Dimensions =
    Dimensions(
...
fun convolve(input: Tensor3, kernels: Tensor3, padding: Padding?, stride: Dimensions?): Matrix =
    Matrix(convOutputDims(input[0].dimensions, kernels[0].dimensions, padding, stride)) { i, j ->
...
fun kernelsGradient(
    ...
    return Tensor4(outputChannels, inputChannels, kernelHeight, kernelWidth) { o, c, m, n ->
